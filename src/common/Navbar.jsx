            ...
            <div className="collapse navbar-collapse bg-white" id="navbarCollapse">
              <div className="navbar-nav mx-auto">
                ...
                <div className="nav-item dropdown">
                  <Link to='/category' className="nav-link dropdown-toggle" data-bs-toggle="dropdown">Category</Link>
                  <div className="dropdown-menu m-0 bg-secondary rounded-0">
                    <Link to='/category' className="dropdown-item">Vegetables</Link>
                    <Link to='/category' className="dropdown-item">Fruit</Link>
                    <Link to='/category' className="dropdown-item">Bread</Link>
                    <Link to='/category' className="dropdown-item">Meat</Link>
                  </div>
                </div>
